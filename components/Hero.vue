<template>
    <div class="max-width-blue-section grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
        <div class="flex flex-col items-center lg:block row-start-2 lg:row-start-1">
        ...
        <div>
            <img class="w-full" src="~/assets/images/img/illustration-hero.png" alt="illustration du logiciel">
