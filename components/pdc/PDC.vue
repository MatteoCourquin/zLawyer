<template>
    <div class="max-width-blue-section">
        ...
        <p>
        <ul class="cgu-list-disc ml-8">
            <li>Firefox : <a class="text-link" href="https://support.mozilla.org/fr/kb/effacer-les-cookies-pour-supprimer-les-information" target="_blank">https://support.mozilla.org/fr/kb/effacer-les-cookies-pour-supprimer-les-information</a></li>
            <li>Google Chrome : <a class="text-link" href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform=Desktop&hl=fr" target="_blank">https://support.google.com/chrome/answer/95647?co=GENIE.Platform=Desktop&hl=fr</a></li>
            <li>Internet Explorer : <a class="text-link" href="https://support.microsoft.com/fr-fr/help/278835/how-to-delete-cookie-files-in-internet-explorer" target="_blank">https://support.microsoft.com/fr-fr/help/278835/how-to-delete-cookie-files-in-internet-explorer</a></li>
            <li>Safari : <a class="text-link" href="https://support.apple.com/kb/ph31411?locale=fr_FR" target="_blank">https://support.apple.com/kb/ph31411?locale=fr_FR</a></li>
        </ul>
        </p>
        ...
        <h3>7. Remarques</h3>
        <p>Nous devrons mettre à jour cette politique d'utilisation des cookies régulièrement par exemple lorsque nous modifions notre site Web ou les règles le concernant. Nous vous prions de consulter cette page pour prendre connaissance de la dernière version de notre politique d'utilisation des cookies. Si vous avez des questions et/ou des commentaires, veuillez nous contacter à l'adresse e-mail suivante : <a class="text-link" href="mailto:contact@zele-solutions.fr">contact@zele-solutions.fr</a></p>
    </div>
</template>
