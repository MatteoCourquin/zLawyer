    ...
    <div class="max-width-white-section">
        <div class="max-width-white-section-content relative grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="pb-4">
                        <a class="text-link block" href="https://download.teamviewer.com/download/TeamViewerQS.exe">Assistance à distance (Teamviewer)</a>
                        <a class="text-link block" target="_blank" href="https://anydesk.com/fr/downloads">Assistance à distance (Anydesk)</a>
                        <a class="text-link block" href="http://www.zlawyer.fr/private/zlawyerstp.exe">Installation zLawyer</a>
                    </div>
